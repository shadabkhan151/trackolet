...
import com.trackolet.trackolet.helper.ClassScanner;
...
public class ServerManager implements LifecycleObject {
    ...
    public ServerManager(
        ...
        for (Class<?> protocolClass : ClassScanner.findSubclasses(BaseProtocol.class, "com.trackolet.trackolet.protocol")) {
